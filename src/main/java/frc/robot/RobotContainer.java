...
public class RobotContainer {
    ...
    private void setupAutos() {
        ...
        autoChooser.addOption("Left Two point five Piece auto with a new feed command", new PathPlannerAuto("Left Two point five Piece auto with a new feed command"));
