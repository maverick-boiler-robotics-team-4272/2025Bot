...
public class PathfindingPoseParser {
    public static void editPathfindingPoses() {
        ...
        rotationMap.put("Left_Barge", "red ? Rotation2d.fromDegrees(180) : Rotation2d.fromDegrees(0)");
        rotationMap.put("Middle_Barge", "red ? Rotation2d.fromDegrees(180) : Rotation2d.fromDegrees(0)");
        rotationMap.put("Right_Barge", "red ? Rotation2d.fromDegrees(180) : Rotation2d.fromDegrees(0)");
