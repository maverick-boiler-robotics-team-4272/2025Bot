...
public class PathfindingPoseParser {
    public static void editPathfindingPoses() {
        ...
        rotationMap.put("Coral_Station_Right_Close_Point", "red ? Rotation2d.fromDegrees(-126) : Rotation2d.fromDegrees(55)");
        rotationMap.put("Coral_Station_Right_Far_Point", "red ? Rotation2d.fromDegrees(-126) : Rotation2d.fromDegrees(55)");
        rotationMap.put("Coral_Station_Left_Close_Point", "red ? Rotation2d.fromDegrees(126) : Rotation2d.fromDegrees(-55)");
        rotationMap.put("Coral_Station_Left_Far_Point", "red ? Rotation2d.fromDegrees(126) : Rotation2d.fromDegrees(-55)");
        rotationMap.put("Left_Barge", "red ? Rotation2d.fromDegrees(0) : Rotation2d.fromDegrees(180)");
        rotationMap.put("Middle_Barge", "red ? Rotation2d.fromDegrees(0) : Rotation2d.fromDegrees(180)");
        rotationMap.put("Right_Barge", "red ? Rotation2d.fromDegrees(0) : Rotation2d.fromDegrees(180)");
        ...
        try(BufferedReader reader = new BufferedReader(new FileReader("./src/main/deploy/pathplanner/paths/Finding.path"))) {
            ...
            editJavaFile(
                ".\\src\\main\\java\\frc\\robot\\constants\\positions\\PositionContainer.java",
